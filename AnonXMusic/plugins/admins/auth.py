...
@app.on_message(filters.command("yetkiver", "auth") & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(filters.command("yetkial", "unauth") & filters.group & ~BANNED_USERS)
@AdminActual
...
@app.on_message(
    filters.command(["yetkiliste", "authusers"]) & filters.group & ~BANNED_USERS
)
@language
